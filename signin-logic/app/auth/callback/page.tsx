        ...
        try {
          ...
          if (data.session) {
            ...
            if (isIDEFlow) {
              ...
              console.log(
                "🔄 IDE flow detected - redirecting to callback server"
              );
              ...
              try {
                ...
                setMessage(
                  "Failed to redirect. Please copy this URL: " +
              ...
              setTimeout(() => {
                ...
                setMessage(
                  "If the IDE doesn't update automatically, please check the application."
                );
                setIsLoading(false);
              }, 2000);
