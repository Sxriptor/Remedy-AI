    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        <p className="text-sm text-gray-600">
          Create your Colabify account using GitHub to get started with clean
          repository notifications and project management.
        </p>
        ...
        <div className="text-xs text-gray-500 space-y-2">
          <p>
            By signing up, you agree to let Colabify access your GitHub
            repositories for notification purposes.
          </p>
          <p>We only read repository activity and never modify your code.</p>
        </div>
